...
export export function MultiUserSync({ onUserUpdate, onObjectUpdate, onCharacterItemInteraction, onUserPreferencesUpdate, onGroupUpdate, onRoleAction, onCollaborativeAction, onHistoryUpdate, onChatMessage }) {
