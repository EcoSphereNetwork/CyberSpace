...
export export function ParticleEffect({ position, color, particleCount = 100 }) {
...
export export function GlowingEdge({ start, end, color = 'cyan', speed = 0.02, pulseSpeed = 1 }) {
  const ref = useRef();
...
export export function PortalEffect({ position, innerColor = 'cyan', outerColor = 'blue', pulseSpeed = 1 }) {
