 ...
 */
export function executeNmapScan(target, options = '-sV') {
 ...
 */
export function parseNmapResult(scanResult) {
 ...
 */
export function visualizeNmapData(data) {
...
/** Example Usage */
(async function exampleNmapIntegration() {
